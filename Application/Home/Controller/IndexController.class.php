				...
				$str_all.=' <a href="'.U('Index/detail',array('id'=>$va['id'])).'">
								<div class="marked-list">
									...
									<div class="marked-list-box">
										<div class="list-box" ><img style="padding-top: 43%" src="'.$va['img_first'].'"></div>
										...
										<div class="list-box"><img style="padding-top: 43%" src="'.$va['img_second'].'"></div>
			...
			foreach($game_today as $kt => $vt){
				...
				$str_today.=' <a href="'.U('Index/detail',array('id'=>$vt['id'])).'">
								<div class="marked-list">
									...
									<div class="marked-list-box">
										<div class="list-box" ><img style="padding-top: 43%" src="'.$vt['img_first'].'"></div>
										<div class="list-box list-box-span" style="width: 65%;">
											<span class="size4 box-span-width">'.$vt['team_first'].'</span>
											<span class="size3 box-span-width" style="width: 15%">VS</span>
											<span class="size4 box-span-width">'.$vt['team_second'].'</span>
										</div>
										<div class="list-box"><img style="padding-top: 43%" src="'.$vt['img_second'].'"></div>
										<div class="list-box" style="width: auto;"><img style="margin-left: 85%;" src="'.$url.'/images/right-arrow.png" class="right-arrow"></div>
									</div>
								</div>
							</a>';
			...
			foreach($game_tomorrow as $km => $vm){
				...
				$str_tomorrow.=' <a href="'.U('Index/detail',array('id'=>$vm['id'])).'">
								<div class="marked-list">
									...
									<div class="marked-list-box">
										<div class="list-box" ><img style="padding-top: 43%" src="'.$vm['img_first'].'"></div>
										<div class="list-box list-box-span" style="width: 65%;">
											<span class="size4 box-span-width">'.$vm['team_first'].'</span>
											<span class="size3 box-span-width" style="width: 15%">VS</span>
											<span class="size4 box-span-width">'.$vm['team_second'].'</span>
										</div>
										<div class="list-box"><img style="padding-top: 43%" src="'.$vm['img_second'].'"></div>
										<div class="list-box" style="width: auto;"><img style="margin-left: 85%;" src="'.$url.'/images/right-arrow.png" class="right-arrow"></div>
									</div>
								</div>
							</a>';
						...
						<div class="score-left" style="width: 100%;border: none">
							<a href='.U('Index/noticeshow',array('id'=>$val['id'])).'>
								...
								<div class="score-left-list notive-list notive-list-hidden">
									<span style="color: #272769;width:30%">网站公告：</span>		
									<span style="text-indent: 0%;color: #727272">'.$val['title'].'</span>
								</div>
							</a>
						</div>
					</div>

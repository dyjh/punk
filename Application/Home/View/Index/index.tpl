...
<input type="hidden" value="市场列表" id="titles"> 
	...
	<div class="marked-body">
		...
		<!--循环a标签 和a标签包含的内容就可以了-->
		<div class="marked-list-body marked-list-body1">
			<!--<volist name="game_all" id="v">
		...
		<div class="marked-list-body marked-list-body4" style="margin-top: 0.2%;height: 87%">
			<div class="opt-head">
				<div class="opt-list" onclick="opt_active('select',event)"><span>全选</span></div>
				<div class="opt-list" onclick="opt_active('remove',event)"><span>取消</span></div>
				<div class="opt-list" onclick="opt_active('sure',event)"><span>确定</span></div>
			</div>

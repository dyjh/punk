	...
	<div class="widths">
		...
		<form action="/" method="post" onsubmit="return susses('zhuce')">
			...
			<div style="height: 100%;width: 100%;float: left;">
				...
				<div class="input-box-register" style="margin-top: 25%">
				...
				<img src="{:U('Login/verify')}" id="verify_img" style="float: left;height: 60px; width: 126px;margin-top: 35px;">
				...
				<div class="input-box-register">
					...
					<input type="text" name="referrer" placeholder="请输入推荐人ID"  autocomplete="off" id="referee" value="{$num}">

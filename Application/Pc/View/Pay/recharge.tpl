		...
		<div class="body">
			<div class="body-head">
				<div class="trade-scll" style="opacity: 1;text-align: center;">
					<span class="color-fff">充值与提现</span>
				</div>	
			</div>
			<div class="rechange-option">
				<div class="mine-num-list width-three mine-num-list1" onclick="rechange_show(1)">				
					<span style="color: #282828" class="bold size-16">充值</span>
				</div>
				<div class="mine-num-list width-three mine-num-list2" onclick="rechange_show(2)">
					<span class="bold size-16">提现</span>
				</div>				
				<div class="mine-num-list width-three mine-num-list3" onclick="rechange_show(3)">
					<span class="bold size-16">交易记录</span>
				</div>
			</div>

			<!--充值-->
			<div class="rechange-box rechange-box1" style="display: block;position: relative;background: #fff">
				<!--二维码弹窗-->
				<div class="market-sure-box market-sure-erweima">
					<div class="body-head">
						<div class="header-scll" style="opacity: 1;text-align: center;background: #ECA534;">
							<span style="color: #fff;">扫描二维码充值</span>
						</div>	
					</div>
					<div class="input-box-register input-box-erweima" id="erweima">
					...
					<div class="rechange-input" style="border: none;background: none;">
						...
						color: #282828;margin-left: 30%">返回</button>
					</div>
				</div>
				<div class="rechange-gold-box">
					<div class="marked-head-msg rechange-head-msg" style="text-align: center;">
						<span class="color-fff bold size-16">请输入充值金额并选择付款方式</span>
					</div>
					<div class="input-box-register rechange-box-register">
						<span>充值金额：</span>
					...
					<div class="payment">
						...
						<div class="payment-body">
							...
							<div class="payment-body-img payment-body-img3" onclick="rechangeClick(3)">
								<img src="__PUBLIC__/images/qqzf.png">
							</div>
							<div class="payment-body-img payment-body-img4" onclick="rechangeClick(4)">
								<img src="__PUBLIC__/images/bitebi.png">
							</div>
							<div class="payment-body-img payment-body-img5" onclick="rechangeClick(5)" style="position: relative;">
						...
						<div class="take-care">
							...
							<div class="take-body">
								<span>1.每次提现都将收取5%手续费</span>
								<span>2.支付宝充值金额需为100，200，300，500，800</span>
			...
			<div class="rechange-box rechange-box2" style="display: none;">
				<div class="rechange-gold-box">
					...
					<div class="rechange-input" style="border: none;background: none;">
						...
						<button class="zc-input btns tlbtn" onclick="deposit('zhuce')" style="background: #ddd;color: #282828">提交</button>
					</div>

					<div class="take-care">
						<div class="take-head"><span>注意事项</span></div>
						<div class="take-body">
							<p style="opacity: 0"> 55</p>
							<span>1.每次提现都将收取5%手续费</span>
							<span style="color: #f00">PS.如利用本平台进行任何洗钱诈骗行为，本公司将保留权利终止会员服务及冻结账户</span>
						</div>
					</div>
				...
				<div class="rechange-gold-box">
					...
					<div class="rechange-gold-box-by">
						<div class="in-btn-box">
							...
							<!--结束-->
							<!--翻页-->
							<div class="in-list-box list-box-width" style="background: #fff">
								<div class="in-page cursor-pointer in-page-left" onclick="page('pre')">上一页</div>
...
/*二维码弹窗*/
	...
	function erweima(type,message){
        ...
        /*文字滚动*/
	 	...
	 	function deposit(){
			...
			$.post("{:U('Pay/extract_money')}",{bank:bank,bank_number:bank_number,name:name,money:money,password:password,bank_province:bank_province,bank_city:bank_city},function(data){
				...
				error(data['msg'],3500);
				setTimeout(function () {
					window.location.href='__ROOT__/index.php/Pc/Pay/recharge';
				},1000)
			});
		...
		function rechange_show(id){
			...
			$(".mine-num-list span").css({"color":"#7C7C7C","font-weight":"normal"});
			$(".mine-num-list"+id).find('span').css({"color":"#282828","font-weight":"bold"});
		}
</script>
</block>
